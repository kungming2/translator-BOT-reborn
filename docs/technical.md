...
* All routines are currently run on a [Raspberry Pi 4](https://www.raspberrypi.com/products/raspberry-pi-4-model-b/) running [Raspberry Pi OS](https://www.raspberrypi.com/software/). Ziwen runs on its own scheduler that allows it to check for new posts, messages, and commands every three minutes.
